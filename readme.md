...
The docker version for the populair project [Hello World](https://github.com/leachim6/hello-world)

Make sure to see [contributing.md](/contributing.md) for instructions on contributing to the project!

Docker image: [abelkrijgtalles/hello-world:latest](https://hub.docker.com/repository/docker/abelkrijgtalles/hello-world)

## How to build
To build you need to have Docker with BuildX installed

To make the drivers (if you didn't already have a custom one) type this into your terminal:
...
To build and upload the image, type:
